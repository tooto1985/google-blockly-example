...
Blockly.Msg["TITLE"] = "程式碼";
Blockly.Msg["BLOCKS"] = "積木";
Blockly.Msg["LINKTOOLTIP"] = "儲存積木組並提供連結。";
Blockly.Msg["RUNTOOLTIP"] = "於工作區中執行積木組所定義的程式。";
Blockly.Msg["BADCODE"] = "程式錯誤：\n%1";
Blockly.Msg["TIMEOUT"] = "超過最大執行數。";
Blockly.Msg["TRASHTOOLTIP"] = "捨棄所有積木。";
...
Blockly.Msg["TEXTVARIABLE"] = "文字";
Blockly.Msg["HTTPREQUESTERROR"] = "命令出現錯誤。";
Blockly.Msg["LINKALERT"] = "透過此連結分享您的積木組：\n\n%1";
Blockly.Msg["HASHERROR"] = "對不起，「%1」並未對應任何已保存的程式。";
Blockly.Msg["XMLERROR"] = "未能載入您保存的檔案。或許它是由其他版本的Blockly創建？";
Blockly.Msg["BADXML"] = "解析 XML 時出現錯誤：\n%1\n\n選擇'確定'以放棄您的更改，或選擇'取消'以進一步編輯 XML。";